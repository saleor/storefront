...
execSync(
	"pnpm exec vitest run --config vitest.export-harness.config.ts src/lib/content/configurator-seed.export-harness.test.ts",
	{
		cwd: ROOT,
		stdio: "inherit",
	},
...
console.log(
	"[content:export-seed] Updated models in config/saleor/storefront-content.config.yml and storefront-content.snapshot.json",
);
