...
export type AvailableShippingMethodsQuery = { __typename?: 'Query', checkout?: Maybe<{ __typename?: 'Checkout', availableShippingMethods: Array<Maybe<{ __typename?: 'ShippingMethod', id: string, name: string, price?: Maybe<{ __typename?: 'Money', currency: string, amount: number }> }>> }> };
...
export const AvailableShippingMethodsDocument = gql`
    query AvailableShippingMethods($token: UUID!) {
