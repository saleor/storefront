...
import { labels, messages } from "@/checkout-storefront/sections/UserAddressSection/messages";
      ...
      >
        ...
        {displayAddressList && (
          <div className="flex flex-col">
            ...
            <Button
              variant="secondary"
              ariaLabel={formatMessage(labels.addAddress)}
              onClick={() => setDisplayAddressCreate(true)}
              label={formatMessage(messages.addAddress)}
