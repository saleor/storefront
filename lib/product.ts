...
/**
 * When a variant is selected, the variant attributes are shown together with the attributes of the product. Otherwise, only the product
...
export const getSelectedVariantID = (
  ...
  const urlVariant =
    process.browser && router ? router.query.variant?.toString() : undefined;
