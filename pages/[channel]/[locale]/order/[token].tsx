...
function OrderCompletedWithTokenPage({ token }: InferGetStaticPropsType<typeof getStaticProps>) {
  ...
  return (
    <main className="max-w-7xl mx-auto pt-8 px-8">
      ...
      <h1 className="text-2xl  mt-5 font-bold text-gray-800 mb-2">
        Your order number : {order?.number}
      </h1>
      <h1 className="text-1xl  font-semibold text-gray-600 mb-4">Status : {order?.status}</h1>
      <div className="grid grid-cols-2 md:grid-cols-4 mb-20 mt-10  max-w-6xl h-full">
...
export default OrderCompletedWithTokenPage;

OrderCompletedWithTokenPage.getLayout = function getLayout(page: ReactElement) {
