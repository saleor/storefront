...
type OrderConfirmationBodySkeletonProps = {
	/** Accessible loading label — static English on route fallbacks; pass translated text when inside `CheckoutIntlProvider`. */
	loadingLabel?: string;
};

/** Main content skeleton for order confirmation — no i18n. */
export function OrderConfirmationBodySkeleton({
	loadingLabel = "Loading order confirmation",
}: OrderConfirmationBodySkeletonProps) {
	return (
		<main
