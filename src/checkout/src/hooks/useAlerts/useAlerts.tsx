...
import { type Alert, type AlertType, type AlertErrorData, type CheckoutScope, type CustomError } from "./types";
...
import { useGetParsedErrors } from "@/checkout/src/hooks/useGetParsedErrors";
