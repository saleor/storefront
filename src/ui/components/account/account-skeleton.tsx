...
export function AccountOrdersListSkeleton() {
	return (
	...
	return (
		<div className="space-y-6">
			...
			<div className="grid gap-6 lg:grid-cols-[1fr_320px]">
				<div className="bg-muted/20 h-64 animate-pulse rounded-xl border" />
				<div className="bg-muted/20 h-40 animate-pulse rounded-xl border" />
			</div>
		</div>
	);
}
